...
// Values wrap onto a second line when long (no clipping)
...
const STYLE = {
  ...
  paddingLeft: 0,
  paddingRight: 10, // ✅ extra right room so last letter never gets shaved
  paddingTop: 18,
  paddingBottom: 14,
  ...
  // Layout
  labelWidthPx: 120,     // ✅ slightly smaller so values get more room (less wrapping)
  gapPx: 6,
  lineGap: 24,
